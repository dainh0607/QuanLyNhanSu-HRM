...
namespace ERP.Entities.Migrations
{
    ...
    [Migration("20260426103153_AddShiftJobsTables")]
    partial class AddShiftJobsTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.Entities.Models.AttendanceSettings", b =>
                {
                    ...
                    b.Property<bool>("proxy_attendance_with_image")
                        .HasColumnType("bit")
                        .HasColumnName("proxy_attendance_with_image");
                    ...
                    b.Property<string>("unrestricted_location_option")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasColumnName("unrestricted_location_option");
            ...
            modelBuilder.Entity("ERP.Entities.Models.Branches", b =>
                {
                    ...
                    b.Property<string>("phone_country_prefix")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)")
                        .HasColumnName("phone_country_prefix");
            ...
            modelBuilder.Entity("ERP.Entities.Models.ControlPlane.TenantUpgradeRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Sys_TenantUpgradeRequests");
                });

            modelBuilder.Entity("ERP.Entities.Models.ControlPlane.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERP.Entities.Models.Departments", b =>
                {
                    ...
                    b.Property<bool>("is_head_department")
                        .HasColumnType("bit")
                        .HasColumnName("is_head_department");
            ...
            modelBuilder.Entity("ERP.Entities.Models.PayrollPeriods", b =>
                {
                    ...
                    b.Property<string>("applicable_departments")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("applicable_departments");

                    b.Property<string>("applicable_job_titles")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                    ...
                    b.Property<int?>("payroll_type_id")
                        .HasColumnType("int")
                    ...
                    b.HasIndex("payroll_type_id");

                    b.ToTable("PayrollPeriods", (string)null);
                });

            modelBuilder.Entity("ERP.Entities.Models.PayrollTypes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("applicable_branches")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("applicable_branches");
                    ...
                    b.Property<string>("applicable_employees")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("applicable_employees");
                    ...
                    b.Property<string>("viewer_permissions")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("viewer_permissions");
            ...
            modelBuilder.Entity("ERP.Entities.Models.Shifts", b =>
                {
                    ...
                    b.Property<int>("allowed_early_mins")
                        .HasColumnType("int")
                        .HasColumnName("allowed_early_mins");

                    b.Property<int>("allowed_late_mins")
                        .HasColumnType("int")
                        .HasColumnName("allowed_late_mins");
                    ...
                    b.Property<string>("checkin_requirement")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasColumnName("checkin_requirement");

                    b.Property<TimeSpan?>("checkin_window_end")
                        .HasColumnType("time")
                        .HasColumnName("checkin_window_end");

                    b.Property<TimeSpan?>("checkin_window_start")
                        .HasColumnType("time")
                        .HasColumnName("checkin_window_start");

                    b.Property<string>("checkout_requirement")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasColumnName("checkout_requirement");

                    b.Property<TimeSpan?>("checkout_window_end")
                        .HasColumnType("time")
                        .HasColumnName("checkout_window_end");

                    b.Property<TimeSpan?>("checkout_window_start")
                        .HasColumnType("time")
                        .HasColumnName("checkout_window_start");
                    ...
                    b.Property<bool>("is_overtime_shift")
                        .HasColumnType("bit")
                        .HasColumnName("is_overtime_shift");
                    ...
                    b.Property<int?>("max_early_mins")
                        .HasColumnType("int")
                        .HasColumnName("max_early_mins");

                    b.Property<int?>("max_late_mins")
                        .HasColumnType("int")
                        .HasColumnName("max_late_mins");

                    b.Property<int>("meal_count")
                        .HasColumnType("int")
                    ...
                    b.Property<float>("min_working_hours")
                        .HasColumnType("real")
                        .HasColumnName("min_working_hours");
                    ...
                    b.Property<float>("standard_effort")
                        .HasColumnType("real")
                        .HasColumnName("standard_effort");
            ...
            modelBuilder.Entity("ERP.Entities.Models.TenantProfiles", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<decimal?>("charter_capital")
                        .HasColumnType("decimal(18,2)")
                    ...
                    b.Property<string>("default_employee_sort_config")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("default_employee_sort_config");
            ...
            modelBuilder.Entity("ERP.Entities.Models.Branches", b =>
                {
                    b.HasOne("ERP.Entities.Models.Branches", "ParentBranch")
            ...
            modelBuilder.Entity("ERP.Entities.Models.ControlPlane.Transaction", b =>
                {
                    b.HasOne("ERP.Entities.Models.ControlPlane.InvoiceMetadata", "Invoice")
                        .WithMany()
            ...
            modelBuilder.Entity("ERP.Entities.Models.Departments", b =>
                {
                    ...
                    b.HasOne("ERP.Entities.Models.Departments", "ParentDepartment")
            ...
            modelBuilder.Entity("ERP.Entities.Models.JobTitles", b =>
                {
                    ...
                    b.HasOne("ERP.Entities.Models.JobTitles", "ParentJobTitle")
                        .WithMany("SubJobTitles")
                        .HasForeignKey("parent_id")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("ERP.Entities.Models.PayrollPeriods", b =>
                {
                    b.HasOne("ERP.Entities.Models.PayrollTypes", "PayrollType")
                        .WithMany()
                        .HasForeignKey("payroll_type_id")
                        .OnDelete(DeleteBehavior.Restrict);
