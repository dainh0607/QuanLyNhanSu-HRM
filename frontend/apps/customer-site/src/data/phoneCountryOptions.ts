...
export const DEFAULT_PHONE_COUNTRY_VALUE = createPhoneCountryOptionValue(
  'Vietnam',
  VIETNAM_DIAL_CODE,
);

export const getPhoneCountryOptionByValue = (
  value: string,
...
export const getDialCodeByPhoneCountryValue = (value: string): string =>
  getPhoneCountryOptionByValue(value)?.dialCode ?? VIETNAM_DIAL_CODE;
...
export const validatePhoneNumberByCountryValue = (
  value: string,
  phone: string,
): string | null => {
