...
interface ElectronicContractFlowWizardV2Props {
  isOpen: boolean;
  employees: Employee[];
...
const ElectronicContractFlowWizardV2: React.FC<ElectronicContractFlowWizardV2Props> = ({
  isOpen,
  employees,
  employeeOptions,
  signerOptions,
...
export default ElectronicContractFlowWizardV2;
