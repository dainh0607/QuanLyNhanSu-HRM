...
import ElectronicContractFlowWizard from './ElectronicContractFlowWizardV2';
import RegularContractModalApi from './RegularContractModalApi';
...
const ContractsManagementPageApi: React.FC = () => {
...
export default ContractsManagementPageApi;
