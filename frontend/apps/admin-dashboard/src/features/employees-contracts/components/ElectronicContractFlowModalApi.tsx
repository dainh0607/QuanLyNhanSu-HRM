...
interface ElectronicContractFlowModalApiProps {
  isOpen: boolean;
...
const ElectronicContractFlowModalApi: React.FC<ElectronicContractFlowModalApiProps> = ({
  isOpen,
  employeeOptions,
  signerOptions,
  onClose,
...
export default ElectronicContractFlowModalApi;
