...
const PageToolbar: React.FC<PageToolbarProps> = ({ onAddEmployee }) => {
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 shrink-0">
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="relative inline-block text-left group">
          <button
            className="px-4 py-2 bg-white border border-[#192841] text-[#192841] text-sm font-semibold rounded-lg hover:bg-[#192841]/5 flex items-center transition-colors"
          >
            <span className="material-symbols-outlined text-[18px] mr-2 text-[#192841]">download</span>
            Xuất file
            <svg className="w-4 h-4 ml-2 text-[#192841] group-hover:rotate-180 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="absolute right-0 top-full pt-1.5 z-50 hidden group-hover:block transition-all duration-200">
            <div className="w-48 bg-white border border-gray-200 rounded-xl shadow-[0_10px_30px_rgba(0,0,0,0.12)] py-2 overflow-hidden">
              <a className="block px-4 py-2 text-sm text-gray-700 hover:bg-[#192841]/5 hover:text-[#192841] transition-colors" href="#">Thông tin cơ bản</a>
              <a className="block px-4 py-2 text-sm text-gray-700 hover:bg-[#192841]/5 hover:text-[#192841] transition-colors" href="#">Tiền lương/Trợ cấp</a>
              <a className="block px-4 py-2 text-sm text-gray-700 hover:bg-[#192841]/5 hover:text-[#192841] transition-colors" href="#">Lịch sử thăng tiến</a>
            </div>
          </div>
        </div>
            ...
            <div className="relative h-full group/chevron">
              ...
              <div className="absolute right-0 top-full pt-1.5 z-50 hidden group-hover/chevron:block animate-[fadeSlideDown_0.2s_ease-out] z-[1000]">
                <div className="w-52 bg-white border border-gray-200 rounded-xl shadow-[0_10px_30px_rgba(0,0,0,0.12)] py-2 overflow-hidden">
                  ...
                  <a className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-[#192841]/5 hover:text-[#192841] transition-colors" href="#">
                    Thêm nhân viên mới
                  </a>
                  <a className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-[#192841]/5 hover:text-[#192841] transition-colors" href="#">
                    Nhập từ file Excel
